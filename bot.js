   ...
   client.on("message", message => {
    if (message.content === "-help--1") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  Soon :scroll:
         :hearts: الموقع الرسمي للبوت قريب ♥ :hearts: **`)
   ...
   client.on("message", message => {
    if (message.content === "-help-a") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  Soon :scroll:
         :hearts: الموقع الرسمي للبوت Soon  :hearts: **`)
   message.author.sendEmbed(embed)
...
**  ======:blossom:نــتــمــنــآ لــكــم آســتــمـــتــآع :blossom:======  **`)
     message.author.sendEmbed(embed)
      ...
      if (message.content === "-help-a") {
       const embed = new Discord.RichEmbed() 
           .setColor("#FF00FF")
           .setFooter('By Mahmoud Youssef#1110  ')
...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=528611697494065181&permissions=8&scope=bot`)
...
message.channel.stopTyping()
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/jqWShuB**")
